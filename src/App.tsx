...
export default function App() {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 128 128" className="w-24 h-24">
          <rect x="12" y="12" width="104" height="104" rx="18" fill="#2E001E" />
          <path fill="#FF61F6" d="M31 42h12l10 16 10-16h11L59 64l16 22H63L52 69 40 86H29l17-22-15-22z" />
          <path fill="#FF61F6" d="M83 42h16c10 0 18 7 18 18s-8 18-18 18h-5v8H83V42zm11 10v16h5c4 0 7-3 7-8s-3-8-7-8h-5z" />
        </svg>
      ),
      bgColor: 'from-[#470137] to-[#2b001f]'
    },
    {
      name: 'JavaScript',
      icon: (
